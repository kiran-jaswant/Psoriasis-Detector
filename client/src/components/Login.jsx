    ...
    try {
      ...
      if (response.data.success) {
        if (isLogin) {
          ...
          setIsLogin(true);// switch form to login after signup
        }
      } else {
        ...
        <div className="flex w-full max-w-4xl h-[470px] shadow-lg rounded-lg overflow-hidden">
          ...
          <div className="w-1/2 bg-white p-8">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <button
                type="submit"
                className="w-full py-2 bg-gradient-to-r from-pink-400 to-pink-500 text-white rounded-lg font-semibold hover:opacity-90"
              >
                {isLogin ? 'Sign In' : 'Sign Up'}
              </button>
            </form>
